...
- (void)viewDidLoad {
    ...
    self.navigationController.navigationBar.backgroundColor = [UIColor colorWithRed:46/255.0 green:23/255.0 blue:76/255.0 alpha:1];
    [UINavigationBar.appearance setBarTintColor:[UIColor colorWithRed:46/255.0 green:23/255.0 blue:76/255.0 alpha:1]];
